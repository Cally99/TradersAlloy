<template lang="pug">
    div(class="pt-2" style="width:100%;cursor:pointer; min-height:20px; padding: 5px; white-space: pre-wrap;" @click="showDropDown = true")
...
<script>
    ...
    export default Vue.extend({
        ...
        created() {
            if (this.params) {
                this.tagsString = this.params.data.tags;
