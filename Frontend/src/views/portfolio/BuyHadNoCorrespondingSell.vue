<template lang="pug">
    DIV
        div(class="pt-1") {{ numberOfNoBuyAndSellPairs }} BUY transactions had no corresponding SELL
        div
            AgGridVue(
...
<script>
    ...
    export default {
        name: "BuyHadNoCorrespondingSell",
        components: {
            AgGridVue
        },
        props: ['arrAvanza', 'numberOfNoBuyAndSellPairs'],
        beforeMount() {
