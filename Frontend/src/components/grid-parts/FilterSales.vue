...
export default Vue.extend({
    ...
    data : function() {
        return {
            data: [],
            range: {sales_min:-10000000000000, sales_max: 10000000000000},
    ...
    mounted() {
        this.data = [-10000000000000,-30,-30,-20,-20,-20,-10,-10,-5,0,0,0,5,10,20,20,20,20,30,40,10000000000000];
    ...
    methods: {
        click_q_latest() {
            ...
            this.t_latest = false
            this.t_chart = false
            this.params.context.componentParent.setFiltersales_q_latest();
        },
        click_q_chart() {
            this.q_latest = false
            this.q_chart = true
            ...
            this.t_latest = false
            this.t_chart = false
            this.params.context.componentParent.setFiltersales_q_chart();
        },
        click_y_latest() {
            this.q_latest = false
            this.q_chart = false
            ...
            this.t_latest = false
            this.t_chart = false
            this.params.context.componentParent.setFiltersales_y_latest();
        },
        click_y_chart() {
            this.q_latest = false
            this.q_chart = false
            ...
            this.t_latest = false
            this.t_chart = false
            this.params.context.componentParent.setFiltersales_y_chart();
        },
        click_t_latest() {
            this.q_latest = false
            this.q_chart = false
            ...
            this.t_latest = true
            this.t_chart = false
            this.params.context.componentParent.setFiltersales_t_latest();
        },
        click_t_chart() {
            this.q_latest = false
            this.q_chart = false
            ...
            this.t_latest = false
            this.t_chart = true
            this.params.context.componentParent.setFiltersales_t_chart();
        },
        onHistogramSliderMounted() {
            if (this.params.context.componentParent.filters.filter) {
                ...
                this.range.sales_min = this.min_value = filter['sales'] ? filter['sales'].min : -10000000000000;
                this.range.sales_max = this.max_value = filter['sales'] ? filter['sales'].max : 10000000000000;
