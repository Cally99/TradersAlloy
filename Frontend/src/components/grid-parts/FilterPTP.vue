...
export default Vue.extend({
    ...
    data : function() {
        return {
            data: [],
            range: {ptp_min:-1000000000000, ptp_max: 1000000000000},
    ...
    methods: {
        click_q_latest() {
            ...
            this.t_latest = false
            this.t_chart = false
            this.params.context.componentParent.setFilterptp_q_latest();
        },
        click_q_chart() {
            this.q_latest = false
            this.q_chart = true
            ...
            this.t_latest = false
            this.t_chart = false
            this.params.context.componentParent.setFilterptp_q_chart();
        },
        click_y_latest() {
            this.q_latest = false
            this.q_chart = false
            ...
            this.t_latest = false
            this.t_chart = false
            this.params.context.componentParent.setFilterptp_y_latest();
        },
        click_y_chart() {
            this.q_latest = false
            this.q_chart = false
            ...
            this.t_latest = false
            this.t_chart = false
            this.params.context.componentParent.setFilterptp_y_chart();
        },
        click_t_latest() {
            this.q_latest = false
            this.q_chart = false
            ...
            this.t_latest = true
            this.t_chart = false
            this.params.context.componentParent.setFilterptp_t_latest();
        },
        click_t_chart() {
            this.q_latest = false
            this.q_chart = false
            ...
            this.t_latest = false
            this.t_chart = true
            this.params.context.componentParent.setFilterptp_t_chart();
        },
        onHistogramSliderMounted() {
            if (this.params.context.componentParent.filters.filter) {
                ...
                this.range.ptp_min = this.min_value = filter['ptp'] ? filter['ptp'].min : -1000000000000;
                this.range.ptp_max = this.max_value = filter['ptp'] ? filter['ptp'].max : 1000000000000;
