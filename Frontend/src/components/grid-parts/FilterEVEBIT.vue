...
export default Vue.extend({
    ...
    data : function() {
        return {
            data: [],
            range: {ev_ebit_min:-500, ev_ebit_max: 300},
            min_value: -500,
            max_value: 300,
            setRange: false,
            q_latest: false,
    ...
    methods: {
        click_q_latest() {
            ...
            this.t_latest = false
            this.t_chart = false
            this.params.context.componentParent.setFilterev_ebit_q_latest();
        },
        click_q_chart() {
            this.q_latest = false
            this.q_chart = true
            ...
            this.t_latest = false
            this.t_chart = false
            this.params.context.componentParent.setFilterev_ebit_q_chart();
        },
        click_y_latest() {
            this.q_latest = false
            this.q_chart = false
            ...
            this.t_latest = false
            this.t_chart = false
            this.params.context.componentParent.setFilterev_ebit_y_latest();
        },
        click_y_chart() {
            this.q_latest = false
            this.q_chart = false
            ...
            this.t_latest = false
            this.t_chart = false
            this.params.context.componentParent.setFilterev_ebit_y_chart();
        },
        click_t_latest() {
            this.q_latest = false
            this.q_chart = false
            ...
            this.t_latest = true
            this.t_chart = false
            this.params.context.componentParent.setFilterev_ebit_t_latest();
        },
        click_t_chart() {
            this.q_latest = false
            this.q_chart = false
            ...
            this.t_latest = false
            this.t_chart = true
            this.params.context.componentParent.setFilterev_ebit_t_chart();
        },
        onHistogramSliderMounted() {
            if (this.params.context.componentParent.filters.filter) {
                ...
                this.range.ev_ebit_min = this.min_value = filter['evebit'] ? filter['evebit'].min : -500;
                this.range.ev_ebit_max = this.max_value = filter['evebit'] ? filter['evebit'].max : 300;
