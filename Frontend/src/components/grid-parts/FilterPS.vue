...
export default Vue.extend({
    ...
    methods: {
        click_q_latest() {
            ...
            this.t_latest = false
            this.t_chart = false
            this.params.context.componentParent.setFilterps_q_latest();
        },
        click_q_chart() {
            this.q_latest = false
            this.q_chart = true
            ...
            this.t_latest = false
            this.t_chart = false
            this.params.context.componentParent.setFilterps_q_chart();
        },
        click_y_latest() {
            this.q_latest = false
            this.q_chart = false
            ...
            this.t_latest = false
            this.t_chart = false
            this.params.context.componentParent.setFilterps_y_latest();
        },
        click_y_chart() {
            this.q_latest = false
            this.q_chart = false
            ...
            this.t_latest = false
            this.t_chart = false
            this.params.context.componentParent.setFilterps_y_chart();
        },
        click_t_latest() {
            this.q_latest = false
            this.q_chart = false
            ...
            this.t_latest = true
            this.t_chart = false
            this.params.context.componentParent.setFilterps_t_latest();
        },
        click_t_chart() {
            this.q_latest = false
            this.q_chart = false
            ...
            this.t_latest = false
            this.t_chart = true
            this.params.context.componentParent.setFilterps_t_chart();
        },
        onHistogramSliderMounted() {
            if (this.params.context.componentParent.filters.filter) {
                ...
                this.range.ps_min = this.min_value = filter['ps'] ? filter['ps'].min : -500;
                this.range.ps_max = this.max_value = filter['ps'] ? filter['ps'].max : 300;
