...
export default Vue.extend({
    ...
    data : function() {
        return {
            data: [],
            range: {enterprise_min:-1000000000000, enterprise_max: 1000000000000},
            min_value: -50,
            max_value: 50,
            setRange: false,
            q_latest: false,
    ...
    methods: {
        click_q_latest() {
            ...
            this.t_latest = false
            this.t_chart = false
            this.params.context.componentParent.setFilterEnterprise_q_latest();
        },
        click_q_chart() {
            this.q_latest = false
            this.q_chart = true
            ...
            this.t_latest = false
            this.t_chart = false
            this.params.context.componentParent.setFilterEnterprise_q_chart();
        },
        click_y_latest() {
            this.q_latest = false
            this.q_chart = false
            ...
            this.t_latest = false
            this.t_chart = false
            this.params.context.componentParent.setFilterEnterprise_y_latest();
        },
        click_y_chart() {
            this.q_latest = false
            this.q_chart = false
            ...
            this.t_latest = false
            this.t_chart = false
            this.params.context.componentParent.setFilterEnterprise_y_chart();
        },
        click_t_latest() {
            this.q_latest = false
            this.q_chart = false
            ...
            this.t_latest = true
            this.t_chart = false
            this.params.context.componentParent.setFilterEnterprise_t_latest();
        },
        click_t_chart() {
            this.q_latest = false
            this.q_chart = false
            ...
            this.t_latest = false
            this.t_chart = true
            this.params.context.componentParent.setFilterEnterprise_t_chart();
        },
        onHistogramSliderMounted() {
            if (this.params.context.componentParent.filters.filter) {
                ...
                this.range.enterprise_min = this.min_value = filter['enterprise'] ? filter['enterprise'].min : -1000000000000;
                this.range.enterprise_max = this.max_value = filter['enterprise'] ? filter['enterprise'].max : 1000000000000;
        ...
        setModel(model) {
            if (model) {
                ...
                this.range.enterprise_min = this.min_value =  -1000000000000;
                this.range.enterprise_max = this.max_value =  1000000000000;
                this.$refs.hist.update({from: this.min_value, to: this.max_value});
