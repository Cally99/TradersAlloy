...
const userScreenService = require('./../../server/services/UserScreenService');
...
describe('userScreenService', () => {
    ...
    it('selectScreens', async () => {
        const screens = JSON.parse(JSON.stringify(await userScreenService.selectScreens(testUser.user_id)));
    ...
    it('insertScreen', async () => {
        ...
        const screen = JSON.parse(JSON.stringify(await userScreenService.insertScreen(screenMock)));
    ...
    it('updateScreen', async () => {
        ...
        const screen = JSON.parse(JSON.stringify(await userScreenService.updateScreen(name, screen_id)));
    ...
    it('updateScreenFilter', async () => {
        ...
        await userScreenService.updateScreenFilter(name, screen_id, filter);
    ...
    it('deleteScreen', async () => {
        ...
        await userScreenService.deleteScreen(screen_id);
